...
public class GDTransactionManager {
	...
	public void createTransaction(Map<String, TransactionStatus> txnStatusMap){
		...
		// the first transaction should will have the propagation as PROPAGATION_REQUIRES_NEW, rest will have PROPAGATION_REQUIRED
	...
	/**
	 * This method commits the transaction for all the transactionStatus present in the map.
	 * @param txnStatusMap
	 */
	...
	/**
	 * This method rollbacks the transaction for all the transactionStatus present in the map.
	 * @param txnStatusMap
	 */
